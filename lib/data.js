...
// TODO(avoidable-cost scoping): this sums max(0, tonnes × (avgCPT − baseline))
// across ALL segments, so tiny per-tonne deltas on very large tonnages inflate
// the headline (~$422k/mo on the Kamoa data). Revisit later — e.g., only count
// segments past the cost-blowout threshold, or net against a tolerance band.
